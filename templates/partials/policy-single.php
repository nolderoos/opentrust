...
$ot_is_pdf          = ($ot_data['view'] ?? '') === 'policy_pdf';
...
$ot_pdf_url     = trailingslashit($ot_base_url) . 'policy/' . $ot_policy->post_name . '/pdf/';
...
<main id="ot-main" class="ot-policy-single">
    <div class="ot-container ot-container--narrow">
        ...
        <?php elseif ($ot_is_pending && !$ot_is_pdf): ?>
        ...
        <div class="ot-policy-single__header">
            ...
            <div class="ot-policy-single__meta">
                ...
                <span class="ot-policy-single__meta-item">
                    ...
                    printf(esc_html__('Version %s', 'opentrust'), esc_html((string) $ot_version)); ?>
                </span>
            ...
            <?php if (!$ot_is_pdf && $ot_meta['downloadable']): ?>
            <div class="ot-policy-single__actions">
                <a href="<?php echo esc_url($ot_pdf_url); ?>" class="ot-btn ot-btn--outline" target="_blank">
        ...
        <?php if (!$ot_is_pdf && count($ot_versions) > 1): ?>
