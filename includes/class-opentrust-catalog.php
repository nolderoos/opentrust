 ...
 * Catalog service.
 *
 * Loads and normalizes the bundled subprocessor and data-practice catalogs
 * used by the admin typeahead autofill. Catalogs are static PHP arrays
 * shipped with the plugin; both are filterable so integrators can extend
